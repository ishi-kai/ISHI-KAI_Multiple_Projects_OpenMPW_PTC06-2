...
.endc
"}
C {devices/code_shown.sym} 250 30 0 0 {name=measurre only_toplevel=false value=".measure dc Vinv when v(vout)=2.5"}
...
C {devices/vsource.sym} -210 160 0 0 {name=vin value=5 savecurrent=false}
